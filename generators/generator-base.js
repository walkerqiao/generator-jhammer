...
const jhaCore = require('jhammer-core');
const packagejs = require('../package.json');
const jhammerUtils = require('./utils');
const constants = require('./generator-constants');
const PrivateBase = require('./generator-base-private');

const JHAMMER_CONFIG_DIR = '.jhammer';
const MODULES_HOOK_FILE = `${JHAMMER_CONFIG_DIR}/modules/jha-hooks.json`;
const GENERATOR_JHAMMER = 'generator-jhammer';
...
module.exports = class extends PrivateBase {
    /**
     * Deprecated
     * Get the JHammer configuration from the .yo-rc.json file.
     *
     * @param {string} namespace - namespace of the .yo-rc.json config file. By default: generator-jhammer
     */
    getJhammerAppConfig(namespace = 'generator-jhammer') {
        this.warning('This method is deprecated. Use getAllJhammerConfig');
    ...
    addElementToMenu(routerName, glyphiconName, enableTranslation, clientFramework) {
        ...
        try {
            if (clientFramework === 'angularX') {
                ...
                jhammerUtils.rewriteFile(
                    {
                        file: navbarPath,
                        needle: 'jhammer-needle-add-element-to-menu',
                        // prettier-ignore
                        splicable: [`<li class="nav-item" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}">
                                <a class="nav-link" routerLink="${routerName}" (click)="collapseNavbar()">
                                    ...
                                    <span${enableTranslation ? ` jhaTranslate="global.menu.${routerName}"` : ''}>${_.startCase(routerName)}</span>
                                </a>
                            </li>`
                    ]
                    },
            ...
            this.log(
                `${chalk.yellow('\nUnable to find ') +
                    navbarPath +
                    chalk.yellow(' or missing required jhammer-needle. Reference to ') +
    ...
    addExternalResourcesToRoot(resources, comment) {
        ...
        try {
            jhammerUtils.rewriteFile(
                {
                    file: indexFilePath,
                    needle: 'jhammer-needle-add-resources-to-root',
            ...
            this.log(
                `${chalk.yellow('\nUnable to find ') +
                    indexFilePath +
                    chalk.yellow(' or missing required jhammer-needle. Resources are not added to JHammer app.\n')}`
            );
            this.debug('Error:', e);
        }
    }
                ...
                jhammerUtils.rewriteFile(
                    {
                        ...
                        needle: 'jhammer-needle-add-element-to-admin-menu',
                        // prettier-ignore
                        splicable: [`<li>
                        <a class="dropdown-item" routerLink="${routerName}" routerLinkActive="active" (click)="collapseNavbar()">
                            <fa-icon [icon]="'${glyphiconName}'" [fixedWidth]="true"></fa-icon>&nbsp;
                            <span${enableTranslation ? ` jhaTranslate="global.menu.admin.${routerName}"` : ''}>${_.startCase(routerName)}</span>
                        </a>
                    </li>`
                    ]
                    },
    ...
    addEntityToWebpack(microserviceName, clientFramework) {
        ...
        try {
            jhammerUtils.rewriteFile(
                {
                    file: webpackDevPath,
                    needle: 'jhammer-needle-add-entity-to-webpack',
        ...
        try {
            if (this.clientFramework === 'angularX') {
                ...
                jhammerUtils.rewriteFile(
                    {
                        file: entityMenuPath,
                        needle: 'jhammer-needle-add-entity-to-menu',
                        splicable: [
                            // prettier-ignore
                            this.stripMargin(`|<li>
                             ...
                             |                            <span${enableTranslation ? ` jhaTranslate="global.menu.entities.${entityTranslationKeyMenu}"` : ''}>${_.startCase(routerName)}</span>
                             |                        </a>
                             |                    </li>`)
                        ]
                    },
    ...
    addEntityToModule(
        ...
        try {
            if (clientFramework === 'angularX') {
                ...
                const isEntityAlreadyGenerated = jhammerUtils.checkStringInFile(entityModulePath, 'loadChildren', this);
                ...
                jhammerUtils.rewriteFile(
                    {
                        ...
                        needle: 'jhammer-needle-add-entity-route',
                ...
                jhammerUtils.rewriteFile(
                    {
                        ...
                        needle: 'jhammer-needle-add-route-import',
                ...
                jhammerUtils.rewriteFile(
                    {
                        file: indexModulePath,
                        needle: 'jhammer-needle-add-route-path',
                        splicable: [
                            this.stripMargin(
                ...
                jhammerUtils.rewriteFile(
                    {
                        ...
                        needle: 'jhammer-needle-add-reducer-import',
                        splicable: [
                            // prettier-ignore
                ...
                jhammerUtils.rewriteFile(
                    {
                        file: indexReducerPath,
                        needle: 'jhammer-needle-add-reducer-type',
                ...
                jhammerUtils.rewriteFile(
                    {
                        file: indexReducerPath,
                        needle: 'jhammer-needle-add-reducer-combine',
