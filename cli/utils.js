...
const CLI_NAME = 'jhammer';
const GENERATOR_NAME = 'generator-jhammer';
...
const initHelp = (program, cliName) => {
    program.on('--help', () => {
        ...
        logger.info(`  For more info visit ${chalk.blue('https://www.qiaoguoqiang.cn')}`);
        logger.info('');
    });
...
const done = () => {
    logger.info(chalk.green.bold('Congratulations, JHammer execution is complete!'));
};
